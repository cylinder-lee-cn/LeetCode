...
# print(s.lemonadeChange([5, 5, 20, 5, 5, 10, 5, 10, 5, 20]))
print(
    s.lemonadeChange(
...
假设wallet里5元，10元，20元均为零。

* 收入5元，不用找零，5元计数+1
* 收入10元，10元计数+1，5元计数-1
* 收入20元，20元计数+1，如有10元-> 10元计数-1，5元计数-1。如果没有10元，5元计数-3
* 检查5元的计数是否有<0，如果是的话就说明找不开钱了。
"""
